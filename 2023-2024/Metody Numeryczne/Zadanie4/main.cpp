...
void algorytmThomasa(const gsl_vector *diag, const gsl_vector *e, const gsl_vector *f, const gsl_vector *b, gsl_vector *y) {
    ...
    // Zwolnienie pamięci wektorow tymczasowych
...
void wypenienieWektoraB(gsl_vector *b){
    ...
    // Odejmuje od ostatniego wiersza macierzy niewiadomych y wiersz pierwszy z pojedyncza wartoscia y0 = 1, wowczas otrzymamy w ostatnim wierszu wartosci trojdiagonalne pozbawione wartosci y0 na poczatku wiersza, a dla ostatniego wiersza wektora b otrzymamy wartosc -1
