...
IMPLICIT NONE
REAL, DIMENSION(6), PARAMETER :: v = (/10.0, 200.0, 3000.0, 40000.0, 500000.0, 6000000.0/)
REAL :: total
LOGICAL :: flag

WRITE(*, "( ' wartosci macierzy v ', 6(E10.3, 5X) )") v
WRITE(*, "( ' wartosci macierzy v ', 6(E10.1, 5X) )") v
WRITE(*, "( ' wartosci macierzy v ', 6(ES10.2, 5X) )") v
WRITE(*, "( ' wartosci macierzy v ', 6(EN12.4, 5X) )") v
