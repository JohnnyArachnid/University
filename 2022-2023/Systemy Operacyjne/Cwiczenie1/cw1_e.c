...
Kazdy utworzony proces potomny jest liderem swojej grupy procesow [Funkcja setpgid(0,proces)]*/
...
// W pliku Odpowiedzi.txt zawarlem wytlumacznie dlaczego przy n-krotnym wywolaniu funkcji fork powstanie 2^n procesow.